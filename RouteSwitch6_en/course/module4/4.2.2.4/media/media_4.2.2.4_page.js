...
(DrawActivity = function(container, id, manifest, answerArr, lineObjArr) {
    ...
    function imageLoaded(imgs) {
        ...
        bg.graphics.beginFill("#fff").drawRect(0,30,600,330);
        ...
        if (id == 5 || id == 6 || id == 7 || id == 8) {
            ...
            line.graphics.setStrokeStyle(2, 'round', 'round').beginStroke("#000").moveTo(450.95 - mainCont.x, 48.7).lineTo(880.95 - mainCont.x, 48.7);
            mainCont.addChild(line);

            line.graphics.setStrokeStyle(2, 'round', 'round').beginStroke("#000").moveTo(500 - mainCont.x, 48.7).lineTo(500 - mainCont.x, 105);
            mainCont.addChild(line);

            if (id == 8) {
                line.graphics.setStrokeStyle(2, 'round', 'round').beginStroke("#000").moveTo(700 - mainCont.x, 48.7).lineTo(700 - mainCont.x, 85);
                mainCont.addChild(line);
            } else {
                line.graphics.setStrokeStyle(2, 'round', 'round').beginStroke("#000").moveTo(700 - mainCont.x, 48.7).lineTo(700 - mainCont.x, 105);
                mainCont.addChild(line);
            }

            if (id == 8) {
                line.graphics.setStrokeStyle(2, 'round', 'round').beginStroke("#000").moveTo(845 - mainCont.x, 48.7).lineTo(845 - mainCont.x, 200);
                mainCont.addChild(line);
            } else {
                line.graphics.setStrokeStyle(2, 'round', 'round').beginStroke("#000").moveTo(843 - mainCont.x, 48.7).lineTo(843 - mainCont.x, 105);
                mainCont.addChild(line);
            }
            stage.update();
        }
        ...
        for (p = 0; p < lineObjArr.length; p++) {
            ...
            lineToY1 = manifest[lineObjArr[p][0]].y - mainCont.y + manifest[lineObjArr[p][0]].height + 15;
            lineToX2 = manifest[lineObjArr[p][1]].x - mainCont.x + manifest[lineObjArr[p][1]].width / 2;
            lineToY2 = manifest[lineObjArr[p][1]].y - mainCont.y + manifest[lineObjArr[p][1]].height + 15;
    ...
    btn1 = getCJSElement("BLUE_BUTTON", { x: 358.3, y: 440.85, width: 125, height: 21, div: "slide_" + id, compId: "ID_check" + id, id: "check", callback: checkBtnHandler, enabled: "true" });
    container.addChild(btn1);

    //alert(btn1.enabled);

    btn2 = getCJSElement("BLUE_BUTTON", { x: 500.75, y: 440.85, width: 125, height: 21, div: "slide_" + id, compId: "ID_undo" + id, id: "undo", callback: undoHandler, enabled: "true" });
    container.addChild(btn2);

    btn3 = getCJSElement("BLUE_BUTTON", { x: 650.2, y: 440.85, width: 125, height: 21, div: "slide_" + id, compId: "ID_reset" + id, id: "reset", callback: resetHandler, enabled: "true" });
    container.addChild(btn3);

    answerBtn = getCJSElement("BLUE_BUTTON", { x: 800.65, y: 440.85, width: 125, height: 21, div: "slide_" + id, compId: "ID_answer" + id, id: "answer", callback: answerHandler, enabled: "true" });
    container.addChild(answerBtn);

    hideBtn = getCJSElement("BLUE_BUTTON", { x: 800.65, y: 440.85, width: 125, height: 21, div: "slide_" + id, compId: "ID_hide" + id, id: "hide", callback: answerHandler, enabled: "true" });
    hideBtn.visible = false;
    container.addChild(hideBtn);


    ansPopupWindow = getCJSElement("TEXTBOX", { x: 510.45, y: 133.85, width: 240, height: 180, subType: "CLOSABLE", titleId: "ID_s" + id + "_InCorrectTitle", bodyId: "ID_s" + id + "_InCorrectText", visible: "0" });
...
(slideViewDidLoad = function(container, id) {
    ...
    if (id == 1) {
        var manifest;
        var answerArr;
        manifest = [{ src: "images/computer.png", id: "computer0", x: 391.75, y: 244.45, width: 53, height: 44 },
            { src: "images/computer.png", id: "computer1", x: 800.45, y: 131.95, width: 53, height: 44 },
            { src: "images/computer.png", id: "computer2", x: 840.45, y: 244.45, width: 53, height: 44 },
            { src: "images/hub.png", id: "hub0", x: 528.65, y: 244.45, width: 41, height: 41 },
            { src: "images/hub.png", id: "hub1", x: 610.55, y: 84.2, width: 41, height: 41 },
            { src: "images/hub.png", id: "hub2", x: 698.45, y: 244.45, width: 41, height: 41 },
    ...
    if (id == 2) {
        ...
        manifest = [{ src: "images/router.png", id: "router0", x: 618.7, y: 70.4, width: 56, height: 40 },
            { src: "images/computer.png", id: "computer3", x: 451.45, y: 154.85, width: 53, height: 44 },
            { src: "images/computer.png", id: "computer4", x: 441.75, y: 220.35, width: 53, height: 44 },
            { src: "images/computer.png", id: "computer5", x: 451.45, y: 281.85, width: 53, height: 44 },
            { src: "images/computer.png", id: "computer6", x: 795.45, y: 154.85, width: 53, height: 44 },
            { src: "images/computer.png", id: "computer7", x: 824.45, y: 220.35, width: 53, height: 44 },
            { src: "images/computer.png", id: "computer8", x: 801.45, y: 281.85, width: 53, height: 44 },
            { src: "images/hub.png", id: "hub3", x: 626.85, y: 131.15, width: 41, height: 41 },
            { src: "images/hub.png", id: "hub4", x: 546.95, y: 219, width: 41, height: 41 },
            { src: "images/hub.png", id: "hub5", x: 706.75, y: 219, width: 41, height: 41 },
    ...
    if (id == 3) {
        ...
        manifest = [{ src: "images/router.png", id: "router0", x: 618.7, y: 70.4, width: 56, height: 40 },
            ...
            { src: "images/computer.png", id: "computer7", x: 824.45, y: 220.35, width: 53, height: 44 },
            { src: "images/computer.png", id: "computer8", x: 801.45, y: 281.85, width: 53, height: 44 },
            { src: "images/switch.png", id: "switch0", x: 612.85, y: 131.15, width: 66, height: 32 },
            { src: "images/hub.png", id: "hub4", x: 546.95, y: 219, width: 41, height: 41 },
            { src: "images/hub.png", id: "hub5", x: 706.75, y: 219, width: 41, height: 41 },
    ...
    if (id == 4) {
        ...
        manifest = [{ src: "images/router.png", id: "router0", x: 632, y: 70.4, width: 56, height: 40 },
            { src: "images/switch.png", id: "switch0", x: 627.9, y: 138.95, width: 66, height: 32 },
            { src: "images/switch.png", id: "switch1", x: 514.9, y: 220.35, width: 66, height: 32 },
            { src: "images/switch.png", id: "switch2", x: 744.05, y: 221.6, width: 66, height: 32 },
            { src: "images/computer.png", id: "computer4", x: 446.45, y: 281.85, width: 53, height: 44 },
            { src: "images/computer.png", id: "computer5", x: 594.65, y: 281.85, width: 53, height: 44 },
            { src: "images/computer.png", id: "computer6", x: 677.15, y: 281.85, width: 53, height: 44 },
            { src: "images/computer.png", id: "computer7", x: 830.45, y: 281.85, width: 53, height: 44 },
    ...
    if (id == 5) {
        ...
        manifest = [{ src: "images/switch.png", id: "switch0", x: 466, y: 98.35, width: 66, height: 32 },
            { src: "images/hub.png", id: "hub4", x: 479.4, y: 160.85, width: 41, height: 41 },
            { src: "images/computer.png", id: "computer4", x: 460.45, y: 231.85, width: 53, height: 44 },
            { src: "images/computer.png", id: "computer5", x: 554.65, y: 231.85, width: 53, height: 44 },

            { src: "images/switch.png", id: "switch1", x: 670.9, y: 98.35, width: 66, height: 32 },
            { src: "images/server-file.png", id: "server0", x: 653.55, y: 206, width: 42, height: 59 },
            { src: "images/computer.png", id: "computer6", x: 734, y: 220.75, width: 53, height: 44 },

            { src: "images/router.png", id: "router2", x: 815, y: 98.35, width: 56, height: 40 },
            { src: "images/server-file.png", id: "server0", x: 822.55, y: 259.25, width: 42, height: 59 },
    ...
    if (id == 6) {
        ...
        manifest = [{ src: "images/switch.png", id: "switch0", x: 466, y: 98.35, width: 66, height: 32 },
            { src: "images/hub.png", id: "hub4", x: 479.4, y: 160.85, width: 41, height: 41 },
            { src: "images/computer.png", id: "computer4", x: 460.45, y: 270.85, width: 53, height: 44 },
            { src: "images/computer.png", id: "computer5", x: 554.65, y: 270.85, width: 53, height: 44 },
    ...
    if (id == 7) {
        ...
        manifest = [{ src: "images/switch.png", id: "switch0", x: 466, y: 98.35, width: 66, height: 32 },
            { src: "images/hub.png", id: "hub4", x: 479.4, y: 160.85, width: 41, height: 41 },
            { src: "images/computer.png", id: "computer4", x: 460.45, y: 227.85, width: 53, height: 44 },
            { src: "images/computer.png", id: "computer5", x: 550.65, y: 243.85, width: 53, height: 44 },

            { src: "images/hub.png", id: "hub1", x: 680.9, y: 98.35, width: 41, height: 41 },
            { src: "images/server-file.png", id: "server0", x: 653.55, y: 206, width: 42, height: 59 },
            { src: "images/computer.png", id: "computer6", x: 734, y: 220.75, width: 53, height: 44 },

            { src: "images/switch.png", id: "switch2", x: 815, y: 98.35, width: 56, height: 40 },
            { src: "images/server-file.png", id: "server0", x: 822.55, y: 259.25, width: 42, height: 59 },
    ...
    if (id == 8) {
        ...
        manifest = [{ src: "images/switch.png", id: "switch0", x: 466, y: 98.35, width: 66, height: 32 },
            ...
            { src: "images/hub.png", id: "hub2", x: 680.9, y: 85.35, width: 41, height: 41 },
            { src: "images/server-file.png", id: "server1", x: 653.55, y: 206, width: 42, height: 59 },
            { src: "images/computer.png", id: "computer2", x: 734, y: 220.75, width: 53, height: 44 },

            { src: "images/switch.png", id: "switch2", x: 815, y: 170.35, width: 56, height: 40 },
            { src: "images/server-file.png", id: "server0", x: 822.55, y: 259.25, width: 42, height: 59 },
